...
pub struct RingFixed<'b, E: Copy + PartialEq> {
    buffer: &'b mut [E],
    head: usize,
}

impl<'b, E: Copy + PartialEq> RingFixed<'b, E> {
...
impl<'b, E: Copy + PartialEq> From<&'b mut [E]> for RingFixed<'b, E> {
...
impl<'b, E: Copy + PartialEq> Index<usize> for RingFixed<'b, E> {
    type Output = E;
...
impl<'b, E: Copy + PartialEq> IndexMut<usize> for RingFixed<'b, E> {
    #[inline]
